...
def parse_opts():
    ...
    parser.add_argument('--root_path', #./datasets/new_data
                        default=None,
                        type=Path,
                        help='Root directory path')
    parser.add_argument('--noise_path', #LD
                        default=None,
                        type=Path,
                        help='Directory path of noise_img')
    parser.add_argument('--clean_path', #FD
                        default=None,
                        type=Path,
                        help='clean_img file path')
